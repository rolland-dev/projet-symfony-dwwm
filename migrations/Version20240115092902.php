 ...
 */
final class Version20240115092902 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recettes (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, temps DOUBLE PRECISION DEFAULT NULL, personne INT DEFAULT NULL, difficulte INT DEFAULT NULL, description LONGTEXT NOT NULL, prix DOUBLE PRECISION DEFAULT NULL, favori TINYINT(1) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', update_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
